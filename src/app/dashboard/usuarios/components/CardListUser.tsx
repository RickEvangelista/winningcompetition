        ...
        <div className="flex flex-col">
            {filteredItems.length === 0 ? ( <h2 className='text-3xl font-semibold'>Nenhum usuário encontrado</h2> ) : (
                <div className="grid grid-cols-1 md:grid cols-2 lg:grid-cols-3 gap-5">
                    {filteredItems.map((i)=> (
                        <div className="flex flex-col border-t-4 border-custom-blue rounded-md shadow-md hover:shadow-lg transition-shadow gap-4 p-5">
                            ...
                            <div className="flex justify-between items-center">
                                ...
                                <Button variant={'danger'} type='button' className='w-1/2'>Deletar</Button>
                            </div>
                        </div>
                    ))}
                </div>
